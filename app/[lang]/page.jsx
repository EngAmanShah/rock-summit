  ...
  features: [
    {
      title: "الجودة والدقة",
      description:
        "التزام لا يتهاون بمعايير الجودة والدقة في كل مشروع نقوم بتنفيذه.",
    },
    {
      title: "خبرات متنوعة",
      description:
        "خبرة واسعة في مشاريع المباني السكنية والتجارية والحكومية والبنية التحتية.",
    },
    {
      title: "السلامة أولاً",
      description:
        "بروتوكولات سلامة شاملة لضمان بيئات عمل آمنة وتسليم المشاريع بأعلى درجات الحماية.",
    },
    {
      title: "التسليم في الوقت المحدد",
      description:
        "سجل وقائع يثبت قدرتنا على إنهاء المشاريع في الوقت المحدد مع الحفاظ على أعلى معايير الجودة.",
    },
  ],
